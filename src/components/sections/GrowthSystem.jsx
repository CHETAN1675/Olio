export default function GrowthSystem() {
  return (
    <section className="w-full py-20 px-6 lg:px-20 flex flex-col items-center gap-14">
      ...
      {/* Content */}
      <div className="flex flex-col lg:flex-row gap-16 max-w-7xl w-full">
        
        {/* LEFT SIDE */}
        <div className="flex flex-col divide-y divide-gray-300 max-w-xl">
          ...
          <div className="flex gap-6 py-10">
            ...
            <div>
              ...
              <div className="w-40 h-1 bg-yellow-400 mt-4"></div>
            </div>
          </div>
          ...
          <div className="flex gap-6 py-10">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                ...
                the entire execution is handled so leadership can focus on running the business.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-6 py-10">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                ...
                no generic frameworks, just strategies built for the specific reality at hand.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* RIGHT SIDE (FUNNEL) */}
        <div className="bg-[#F0F5FF] rounded-2xl p-6 w-full max-w-xl mx-auto flex justify-center">
          
          <div className="w-full max-w-[536px] flex flex-col gap-4">

            {/* Layer 1 */}
            <div
              className="text-white text-center py-6 px-4 transition-transform duration-300 hover:-translate-y-1"
              style={{
                background: "#0B2A66",
            ...
            >
              ...
              <p className="text-sm">
                Up to 18,000* prospects within your client profile
              </p>
            </div>
            ...
            >
              ...
              <p className="text-sm">
                Up to 9,000* marketing-qualified leads
              </p>
            </div>
            ...
            >
              ...
              <p className="text-sm">
                200* sales-qualified meetings with decision-makers
              </p>
            </div>
